package com.techietipps.itshelpdeskservice.config;

import com.techietipps.itshelpdeskservice.services.TicketServiceImpl;
...
public class RabbitMQConfig {
    ...
    @Value("${itshelpdesk.recruitment.queue}")
    String queueName;
